    ...
    return (
        <div className="w-full max-w-6xl mx-auto">
            <div className="flex flex-col items-center text-center space-y-4 mb-16">
                ...
                <h1 className="text-4xl md:text-5xl font-bold tracking-tight">Flexible Court Packages</h1>
                <p className="text-muted-foreground max-w-[600px] text-lg">
                    Save more when you buy hours in bulk. Choose a package that fits your playing schedule.
                </p>
            </div>
