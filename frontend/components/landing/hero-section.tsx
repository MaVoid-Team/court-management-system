...
export function HeroSection() {
    ...
    const headline = "Book Your";
    const headline2 = "Court.";
        ...
        >
            ...
            <div className="relative z-10 max-w-4xl">
                ...
                <p className="hero-sub opacity-0 mt-8 max-w-md text-base sm:text-lg text-muted-foreground leading-relaxed">
                    Check live availability, compare courts, and secure your spot instantly. No calls needed.
                </p>

                <div className="mt-10 flex flex-wrap items-center gap-4">
                    <Button asChild className="hero-btn opacity-0 group font-bold h-14 px-8 transition-all duration-200 hover:gap-4">
            ...
            {/* Scroll cue */}
            <div className="scroll-cue opacity-0 absolute bottom-8 left-8 md:left-16 lg:left-24 flex items-center gap-2 text-muted-foreground/60">
                <span className="text-[11px] tracking-[0.2em] uppercase font-medium">Scroll to explore</span>
